...
def run(context):
    try:
        if element_exists(context, 'div_test_ai_news'):
            ...
            context.perform_gesture('tap', 'lnk_thirteen_image')
            context.perform_gesture('tap', 'lnk_tisqa_image')
            context.perform_gesture('tap', 'lnk_transforming_image')
            context.perform_gesture('tap', 'lnk_moving_image')
            context.perform_gesture('tap', 'lnk_trends_image')
            context.perform_gesture('tap', 'lnk_thirty_image')
    finally:
